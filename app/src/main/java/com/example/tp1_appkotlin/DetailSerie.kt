...
@Composable
fun DetailSerie(viewModel: MainViewModel, windowClass: WindowSizeClass, id : String) {
    ...
    when (classeLargeur) {
        WindowWidthSizeClass.Compact -> {
            Column(
                ...
                AsyncImage(
                    model = "https://image.tmdb.org/t/p/w500/${detailSerie.backdrop_path}",
